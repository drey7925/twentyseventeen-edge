 ...
 */
@Autonomous(name="Playback Auton 2017")
public class RecordAutonSeventeen extends SynchronousOpMode {
        ...
        public void initm() {
            ...
            l0.setMode(DcMotorController.RunMode.RUN_WITHOUT_ENCODERS);
            r0.setMode(DcMotorController.RunMode.RUN_WITHOUT_ENCODERS);
            c.setMode(DcMotorController.RunMode.RUN_WITHOUT_ENCODERS);
